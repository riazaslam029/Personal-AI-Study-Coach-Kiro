...
- [ ] **1.2** Scaffold the FastAPI backend
...
- [ ] **1.3** Configure the database connection and run initial migration
...
- [ ] **1.4** Scaffold the React frontend
...
- [ ] **1.5** Implement the API client and auth store stubs
...
- [ ] **2.1** Implement backend auth logic
...
- [ ] **2.2** Implement auth Pydantic schemas
...
- [ ] **2.4** Implement frontend auth pages and flows
...
- [ ] **3.2** Implement backend course endpoints
...
- [ ] **3.3** Implement frontend course management
...
- [ ] **4.1** Implement backend task endpoints
...
- [ ] **4.2** Implement frontend task management
...
- [ ] **5.2** Implement material text extraction
...
- [ ] **5.3** Implement backend material endpoints
...
- [ ] **5.4** Implement frontend material management
...
- [ ] **6.1** Implement the AI service layer
...
- [ ] **6.2** Implement AI assistant API routes
...
- [ ] **6.3** Implement frontend AI assistant page
...
- [ ] **7.1** Implement study planner AI method and prompts
...
- [ ] **7.2** Implement plan service and API routes
...
- [ ] **7.3** Implement frontend planner page
...
- [ ] **8.1** Implement the dashboard page
...
- [ ] **8.2** Wire exam display on dashboard
...
- [ ] **9.1** Implement progress backend support
...
- [ ] **9.2** Implement frontend progress page
...
- [ ] **10.1** Wire adaptive planning prompts throughout the UI
...
- [ ] **10.2** Handle edge cases in plan generation
...
- [ ] **11.1** Global error handling and loading states
...
- [ ] **11.2** Responsive layout and UI polish
...
- [ ] **11.4** Environment and security audit
...
- [ ] **12.2** Deploy the backend to Render
...
- [ ] **12.3** Deploy the frontend to Vercel
...
- [ ] **12.5** End-to-end production smoke test
